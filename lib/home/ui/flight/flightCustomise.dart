...
class FlightCustomisePage extends StatefulWidget {
  const FlightCustomisePage({Key? key, this.ResultIndex, this.TraceId, this.Token}) : super(key: key);
  final ResultIndex;
  final TraceId;
  final Token;
                    ...
                    children: [
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          ...
                          return Column(
                            ...
                            children: [
                              ...
                              Container(
                                width: MediaQuery.of(context).size.width, // Set the width to device width
                                ...
                                child: InputDecorator(
                                  ...
                                  child: DropdownButton<dynamic>(
                                    ...
                                    items: LccBaggage.map<DropdownMenuItem<dynamic>>(
                                          (option) {
                                        return DropdownMenuItem<dynamic>(
                                          value: option,
                                          child: Text( 'Weight: ${option.weight} KG, Price: ₹${option.price}'),
                                        );
                                      },
                                    ).toList(),
                                  ),
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: DropdownButton<dynamic>(
                                  ...
                                  isExpanded: true,
                                  items: mealItems.map<DropdownMenuItem<dynamic>>(( value) {
                                    return DropdownMenuItem<dynamic>(
                                      value: value,
                                      child: Text("${value.airlineDescription} (${value.code})"),
                                    );
                                  }).toList(),
                                ),
                              )
                      ...
                      ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          ...
                          physics: NeverScrollableScrollPhysics(),
                          shrinkWrap: true,
                          itemCount: specialServices![index].segmentSpecialService!.length,
                          itemBuilder: (BuildContext context, int ind) {
                            return ListView.builder(
                                physics: NeverScrollableScrollPhysics(),
                                shrinkWrap: true,
                                itemCount: specialServices![index].segmentSpecialService![ind].ssrService!.length,
                        ...
                        return Column(
                          ...
                          children: [
                            Padding(
                              ...
                              child: GestureDetector(
                                onTap: (){
                                  print(FlightSeats[index]['RowSeats'][0]['Seats'][0]['Origin']);
                                  print(FlightSeats[index]['RowSeats'][0]['Seats'][0]['Destination']);
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(builder: (context) =>
                                        SeatSelectionPage(
                                          origin: FlightSeats[index]['RowSeats'][0]['Seats'][0]['Origin'],
                                          destination: FlightSeats[index]['RowSeats'][0]['Seats'][0]['Destination'],
                                          index: index,
                                        )),
                                  );
                                },
