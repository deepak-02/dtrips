...
import '../../../db/Membership/Membership.dart';
import '../../../db/api.dart';
import '../../global.dart';

class SingleMembershipPage extends StatefulWidget {
  const SingleMembershipPage({Key? key, this.Mplan}) : super(key: key);

  final Mplan;

  @override
  State<SingleMembershipPage> createState() => _SingleMembershipPageState();
}

class _SingleMembershipPageState extends State<SingleMembershipPage> {
                                  ...
                                  children: [
                                    Row(
                                      children: [
                                        ...
                                        Text(
                                          // membershipData.isEmpty? "Delish" : "${membershipData![1]!.plan}",
                                          "Delish",
                                          style: TextStyle(
                                            fontSize: screenSize.width / 20,
                                            fontWeight: FontWeight.bold,
                                    ...
                                    Tooltip(
                                      ...
                                      richMessage: TextSpan(
                                        text:
                                            // membershipData.isEmpty? "Eligible to use in all flights and hotels available in www.dtrips.com , we are associated with 1 million plus hotels and all domestic and international flights" : "${membershipData![1]!.details3}",
    ...
    if (response.statusCode == 200) {
      showDialog<String>(
        ...
        builder: (BuildContext context) => AlertDialog(
          ...
          content: Text(
            "Your purchase for $plan plan is successful and your account will be upgraded soon",
            textAlign: TextAlign.center,
            style: TextStyle(
